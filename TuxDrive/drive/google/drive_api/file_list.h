...
class FileList : public client::JsonCppData {
 public:
  ...
  /**
   * Determine if the '<code>files</code>' attribute was set.
   *
   * @return true if the '<code>files</code>' attribute was set.
   */
  bool has_files() const {
    return Storage().isMember("files");
  }

  /**
   * Clears the '<code>files</code>' attribute.
   */
  void clear_files() {
    MutableStorage()->removeMember("files");
  }


  /**
   * Get a reference to the value of the '<code>files</code>' attribute.
   */
  const client::JsonCppArray<File > get_files() const;

  /**
   * Gets a reference to a mutable value of the '<code>files</code>' property.
   *
   * The page of files.
   *
   * @return The result can be modified to change the attribute value.
   */
  client::JsonCppArray<File > mutable_files();
