...
//     C++: 0.1.4
#ifndef  GOOGLE_DRIVE_API_REPLY_LIST_H_
#define  GOOGLE_DRIVE_API_REPLY_LIST_H_
 ...
 * @ingroup DataObject
 */
class ReplyList : public client::JsonCppData {
 public:
  /**
   ...
   */
  explicit ReplyList(const Json::Value& storage);
   ...
   * @param[in] storage  The underlying data storage for this instance.
   */
  explicit ReplyList(Json::Value* storage);
   ...
   *
   * @return <code>google_drive_api::ReplyList</code>
   */
  const StringPiece GetTypeName() const {
    return StringPiece("google_drive_api::ReplyList");
  }
 ...
 private:
  void operator=(const ReplyList&);
};  // ReplyList
}  // namespace google_drive_api
#endif  // GOOGLE_DRIVE_API_REPLY_LIST_H_
